...
class CaeVecchi_EasyCheckoutBrasil_Block_Onepage_Billship extends Mage_Checkout_Block_Onepage_Billing
{
    ...
    public function buildCountriesSelectBox($addr_type)
    {
        ...
        if (is_null($countryId)) {
            $countryId = Mage::getStoreConfig('easycheckoutbrasil/general/country');
        }
        $select = $this->getLayout()->createBlock('core/html_select')
