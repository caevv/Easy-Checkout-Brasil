<?php
class CaeVecchi_EasyCheckoutBrasil_Model_Service_Quote extends Mage_Sales_Model_Service_Quote
{
    protected function _validate()
    {
        ...
        if (!$this->getQuote()->isVirtual())
        {
            ...
            $addrValidator = Mage::getSingleton('easycheckoutbrasil/type_geo')->validateAddress($address);
        ...
        $addrValidator = Mage::getSingleton('easycheckoutbrasil/type_geo')->validateAddress($this->getQuote()->getBillingAddress());
