...
OPC.Window.prototype = {
    ...
    show: function () {
        ...
        $$('select').invoke('addClassName', 'easycheckoutbrasil-hidden');
        this.window.show();
    },
    hide: function () {
        this.window.hide();
        $$('select').invoke('removeClassName', 'easycheckoutbrasil-hidden')
    },
    ...
    _prepareMarkup: function () {
        ...
        this.window.addClassName('easycheckoutbrasil-window');
...
function open_login() {
    $('easycheckoutbrasil_forgotbox').hide();
    $('easycheckoutbrasil_loginbox').show();
}function open_forgot() {
    $('easycheckoutbrasil_loginbox').hide();
    $('easycheckoutbrasil_forgotbox').show();
